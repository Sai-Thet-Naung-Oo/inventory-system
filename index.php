					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="date" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" readonly>
						</div>
						<div class="form-group col-md-2">
					...
					<form>
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  ...
							  <input type="date" class="form-control datepicker" id="saleDetailsSaleDate"  name="saleDetailsSaleDate" readonly>
						  </div>
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-2">
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="date" class="form-control datepicker" id="saleReportStartDate" name="saleReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="saleReportEndDate">End Date</label>
									<input type="date" class="form-control datepicker" id="saleReportEndDate"  name="saleReportEndDate" readonly>
								  </div>
							  </div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="date" class="form-control datepicker" id="purchaseReportStartDate"  name="purchaseReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="purchaseReportEndDate">End Date</label>
									<input type="date" class="form-control datepicker" id="purchaseReportEndDate"  name="purchaseReportEndDate" readonly>
								  </div>
							  </div>
